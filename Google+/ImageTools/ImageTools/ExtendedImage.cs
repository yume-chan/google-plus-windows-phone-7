...
namespace ImageTools
{
    ...
    public sealed partial class ExtendedImage : ImageBase
    {
        ...
        {
            EventHandler handler = LoadingCompleted;
            if (handler != null)
                handler(this, e);
        }
        ...
        private void Load(Stream stream)
        {
            ...
            using (stream)
            {
                Contract.Requires<NotSupportedException>(stream.CanRead, "Cannot read from the stream.");
                Contract.Requires<NotSupportedException>(stream.CanSeek, "The stream does not support seeking.");
