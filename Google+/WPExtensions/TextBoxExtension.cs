...
namespace WPExtensions
{
    ...
    public partial class Extensions
    {
        ...
        public static void SetUpdateBindingOnChange(FrameworkElement element, bool value)
        {
            ...
            {
                if (GetUpdateBindingOnChange(txtBox) == updateValue)
                    return;
        ...
        public static DependencyProperty SelectAllOnFocusProperty =
            DependencyProperty.RegisterAttached("SelectAllOnFocus", typeof(bool), typeof(Extensions), new PropertyMetadata(default(bool)));
