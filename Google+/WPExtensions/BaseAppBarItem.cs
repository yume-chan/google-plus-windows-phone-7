...
{
    public class BaseAppBarItem: FrameworkElement, IAppBarItem
    {
        ...
        public static DependencyProperty IsEnabledProperty = DependencyProperty.Register("IsEnabled", typeof(bool), typeof(BaseAppBarItem), new PropertyMetadata(true, IsEnabledPropertyChangedEventHandler));
        ...
        public static DependencyProperty DisableLostFocusProperty = DependencyProperty.Register("DisableLostFocus", typeof(bool), typeof(BaseAppBarItem), new PropertyMetadata(false, DisableLostFocusChangedCallback));
        ...
        public static DependencyProperty TextProperty = DependencyProperty.RegisterAttached("Text", typeof(string), typeof(BaseAppBarItem), new PropertyMetadata("appBar", TextPropertyChangedCallback));
        public string Text
        {
            get
            {
        ...
        public new static readonly DependencyProperty VisibilityProperty =
            DependencyProperty.RegisterAttached("Visibility", typeof(Visibility), typeof(BaseAppBarItem), new PropertyMetadata(OnVisibilityChanged));
